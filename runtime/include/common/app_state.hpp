...
//
// This file is the SINGLE SOURCE OF TRUTH for the g_* geometry globals.
// runtime/types.hpp re-exports it; it does not redefine them. Both files say
// so in their headers so neither claims sole ownership.
//
...
inline int64_t g_ffn = 0, g_layers = 0, g_max_positions = 0;
